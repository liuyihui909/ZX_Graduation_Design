...
<div class="width100" style="height: 45px;background: #dd4545;margin-top: 40px;position: relative;z-index: 100;">
    ...
    <div class="width1200 center_yh relative_yh" style="height: 45px;">
        ...
        <div class="left_yh Selected" style="width: 230px;height: 45px;" id="hiddenShow">
            ...
            <span class=" fff" style="height: 45px;line-height: 44px;margin-left: 10px;">分类</span>
            <!--导航展开部分-->
            <div class="downSlide">
...
<div class="width1200 center_yh hidden_yh">
    ...
    <div class="width100 hidden_yh" style="height: 200px;">
        <div class="normalPic">
            <c:forEach items="${zks}" var="data" varStatus="l" end="4" step="1">
